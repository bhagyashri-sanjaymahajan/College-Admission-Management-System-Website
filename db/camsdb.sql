...
(1, 'aboutus', 'About Us', 'The College Admission Management System (CAMS) is a comprehensive software solution designed to streamline and automate the college admission process. It facilitates online application submission, document verification, fee payment, and admission tracking, ensuring a smooth experience for both students and administrative staff. CAMS enhances efficiency, reduces paperwork, and provides real-time updates, making the entire admission process faster, transparent, and user-friendly.', NULL, NULL, NULL, ''),
(2, 'contactus', 'Contact Us', 'SSBT COET Bambhori ,Jalgaon ', 'ssbtcoet@gmail.com', 9921537800, NULL, '10:30 am to 5:30 pm');
